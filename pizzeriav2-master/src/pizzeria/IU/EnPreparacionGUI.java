...
btnMarcarListo.setFont(new Font("Segoe UI", Font.BOLD, 11));
btnMarcarListo.setBackground(new Color(168, 27, 29));
btnMarcarListo.setForeground(Color.WHITE);
btnMarcarListo.setBorder(BorderFactory.createEmptyBorder(6, 15, 6, 15));
...
private void marcarListo() {
    ...
    int idPedido = (int) modeloTabla.getValueAt(fila, 0);
    gestorCocina.marcarComoListo(idPedido);
    cargarDatos();
}
    /**
