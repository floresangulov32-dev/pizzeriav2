...
btnTomarPedido.setFont(new Font("Segoe UI", Font.BOLD, 11));
btnTomarPedido.setBackground(new Color(168, 27, 29));
btnTomarPedido.setForeground(Color.WHITE);
btnTomarPedido.setBorder(BorderFactory.createEmptyBorder(6, 15, 6, 15));
...
private void tomarPedido() {
  ...
  gestorCocina.tomarSiguientePedido();
    cargarDatos();
}
    /**
