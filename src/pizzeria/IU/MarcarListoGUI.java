...
public class MarcarListoGUI extends JPanel {
    ...
    private JPanel crearPanelSuperior() {
        ...
        JLabel lblTitulo = new JLabel("MARCAR PEDIDO COMO LISTO");
    ...
    private JPanel crearPanelInferior() {
        ...
        btnMarcarListo.setFont(new Font("Segoe UI", Font.BOLD, 12));
        btnMarcarListo.setBackground(new Color(46, 204, 113));
        btnMarcarListo.setForeground(Color.WHITE);
        btnMarcarListo.setBorder(BorderFactory.createEmptyBorder(8, 20, 8, 20));
    ...
    private void cargarDatos() {
        ...
        if (enPreparacion.isEmpty()) {
            ...
            txtDetalle.setText("No hay pedidos en preparación para marcar como listos.");
        } else {
    ...
    private void marcarListo() {
        int fila = tablaPedidos.getSelectedRow();
        if (fila == -1) {
            JOptionPane.showMessageDialog(this, "Seleccione un pedido para marcar como listo.", "Advertencia", JOptionPane.WARNING_MESSAGE);
            return;
        }
        ...
        int confirm = JOptionPane.showConfirmDialog(this,
            "¿Marcar el pedido #" + idPedido + " de " + cliente + " como LISTO?\n\n" +
            "El pedido pasará a estado 'LISTO' y estará disponible para entregar.",
            "Confirmar",
            JOptionPane.YES_NO_OPTION,
            JOptionPane.QUESTION_MESSAGE);
        
        if (confirm == JOptionPane.YES_OPTION) {
            boolean exito = gestorCocina.marcarComoListo(idPedido);
            
            if (exito) {
                JOptionPane.showMessageDialog(this,
                    "Pedido #" + idPedido + " marcado como LISTO exitosamente.\n" +
                    "Ahora está disponible para ser entregado.",
                    "Éxito",
                    JOptionPane.INFORMATION_MESSAGE);
                cargarDatos();
            } else {
                JOptionPane.showMessageDialog(this,
                    "Error al marcar el pedido como listo. Intente nuevamente.",
                    "Error",
