...
public class ReporteReservasPeriodoGUI extends JPanel {
    ...
    //private JLabel lblTotalReservas, lblMontoTotal, lblPromedioDiario, lblPendientes, lblEntregadas;
    ...
    public ReporteReservasPeriodoGUI() {
    ...
    private JPanel crearPanelSuperior() {
        ...
        JLabel lblTitulo = new JLabel("REPORTE DE RESERVAS POR PERÍODO");
    ...
    private JPanel crearPanelCentral() {
        ...
        // Panel de resumen
        JPanel panelResumen = new JPanel(new FlowLayout(FlowLayout.CENTER, 15, 8));
        ...
        lblEntregadas.setForeground(new Color(46, 204, 113));
    ...
    private void generarReporte() {
        try {
            ...
            List<Reserva> reservas = gestorReserva.getListaReservas().stream()
                .filter(r -> !r.getFechaReserva().toLocalDate().isBefore(inicio))
                .filter(r -> !r.getFechaReserva().toLocalDate().isAfter(fin))
            ...
            Map<LocalDate, List<Reserva>> reservasPorDia = reservas.stream()
                .collect(Collectors.groupingBy(r -> r.getFechaReserva().toLocalDate()));
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(PanelCentral, javax.swing.GroupLayout.PREFERRED_SIZE, 293, javax.swing.GroupLayout.PREFERRED_SIZE)
